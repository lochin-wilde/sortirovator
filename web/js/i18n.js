...
const TRANSLATIONS = {
  en: {
    ...
    "feedback.queued": "Correction recorded locally ({genre}). No server is connected yet, so nothing was sent.",
    "feedback.hint": "Click a genre in the table to correct it. Corrections are remembered and reused.",
  ...
  ru: {
    ...
    "feedback.queued": "Исправление записано локально ({genre}). Сервер пока не подключён, никуда не отправлено.",
    "feedback.hint": "Нажмите на жанр в таблице, чтобы исправить. Исправления запоминаются и применяются впредь.",
